(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory(require('webxr-polyfill/src/WebXRPolyfill'), require('webxr-polyfill/src/api/XRSystem'), require('webxr-polyfill/src/api/index'), require('webxr-polyfill/src/devices/XRDevice'), require('webxr-polyfill/src/api/XRSpace'), require('webxr-polyfill/src/api/XRWebGLLayer')) :
  typeof define === 'function' && define.amd ? define(['webxr-polyfill/src/WebXRPolyfill', 'webxr-polyfill/src/api/XRSystem', 'webxr-polyfill/src/api/index', 'webxr-polyfill/src/devices/XRDevice', 'webxr-polyfill/src/api/XRSpace', 'webxr-polyfill/src/api/XRWebGLLayer'], factory) :
