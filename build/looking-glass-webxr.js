(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory(require('@lookingglass/webxr-polyfill'), require('@lookingglass/webxr-polyfill/src/api/XRSystem'), require('@lookingglass/webxr-polyfill/src/api/index'), require('@lookingglass/webxr-polyfill/src/devices/XRDevice'), require('@lookingglass/webxr-polyfill/src/api/XRSpace'), require('@lookingglass/webxr-polyfill/src/api/XRWebGLLayer')) :
  typeof define === 'function' && define.amd ? define(['@lookingglass/webxr-polyfill', '@lookingglass/webxr-polyfill/src/api/XRSystem', '@lookingglass/webxr-polyfill/src/api/index', '@lookingglass/webxr-polyfill/src/devices/XRDevice', '@lookingglass/webxr-polyfill/src/api/XRSpace', '@lookingglass/webxr-polyfill/src/api/XRWebGLLayer'], factory) :
